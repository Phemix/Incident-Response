...
rule DebuggerCheck__PEB : AntiDebug DebuggerCheck {
	meta:
		weight = 1
        description = "Detects if walware is debugger aware"
		Author = "naxonez, updated by Femi"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        classifications = "AntiDebug/Anti-VM"
        vti_default_score = 5
...
rule DebuggerCheck__GlobalFlags : AntiDebug DebuggerCheck {
	meta:
		weight = 1
		Author = "naxonez, updated by Femi"
        description = "Detects malware checks for global flags in debugger"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        classifications = "AntiDebug/Anti-VM"
        vti_default_score = 5
        vti_documents_score = 5
...
rule DebuggerCheck__QueryInfo : AntiDebug DebuggerCheck {
	meta:
		weight = 1
        description = "Detects malware checks for process information querying in debugger"
		Author = "naxonez"
        classifications = "AntiDebug/Anti-VM"
        vti_default_score = 5
        vti_documents_score = 5
...
rule DebuggerCheck__RemoteAPI : AntiDebug DebuggerCheck {
	meta:
        ...
        classifications = "AntiDebug/Anti-VM"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        description = "Detects malware checks for remote API in debugger"
        vti_default_score = 5
        vti_documents_score = 5
        vti_scripts_score = 5
        vti_browser_score = 5
...
rule DebuggerHiding__Thread : AntiDebug DebuggerHiding {
	meta:
	    Author = "naxonez, updated by Femi"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        description = "Detects malware checks for hidden threads in debugger"
        classifications = "AntiDebug/Anti-VM"
		weight = 1
        vti_default_score = 5
        vti_documents_score = 5
...
rule DebuggerException__ConsoleCtrl : AntiDebug DebuggerException {
	meta:
		...
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        classifications = "AntiDebug/Anti-VM"
        description = "Detects malware generation of a console control event in debugger"
        vti_default_score = 5
        vti_documents_score = 5
        vti_scripts_score = 5
        vti_browser_score = 5
...
rule DebuggerException__SetConsoleCtrl : AntiDebug DebuggerException {
	meta:
		weight = 1
		Author = "naxonez, updated by Femi"
        description = " AntiDebug DebuggerException detection"
        classifications = "AntiDebug/Anti-VM"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        vti_default_score = 5
        vti_documents_score = 5
...
{
    meta:
        author = "Malware Utkonos, updated by Femi"
        original_author = "naxonez"
        classifications = "AntiDebug/Anti-VM"
        description = "Tactic_DefensiveEvasion Technique_AntiDebugging"
...
rule SEH_Init : Tactic_DefensiveEvasion Technique_AntiDebugging SubTechnique_SEH
{
    meta:
        author = "Malware Utkonos, updated by Femi"
        original_author = "naxonez"
        description = "Tactic_DefensiveEvasion" 
        classifications = "AntiDebug/Anti-VM"
        source = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
        vti_default_score = 5
        vti_documents_score = 5
...
{
	meta:
		Author = "Nick Hoffman, updated by Femi "
...
rule Check_OutputDebugStringA_iat
{
	...
	meta:
		Author = "http://twitter.com/j0sm1, updated by Femi"
		Description = "Detect in IAT OutputDebugstringA"
		Date = "20/04/2015"
        classifications = "Hooking"
		Sample = "de1af0e97e94859d372be7fcf3a5daa5"
        vti_default_score = 5
        vti_documents_score = 5
        vti_scripts_score = 5
...
rule DebuggerCheck__MemoryWorkingSet : AntiDebug DebuggerCheck {
	meta:
		author = "Fernando Mercês, updated by Femi"
		date = "2015-06"
...
rule WMI_VM_Detect : WMI_VM_Detect
{
    meta:
        ...
        author = "Joe Giron, updated by Femi"
        date = "2015-09-25"
        vti_default_score = 5
        vti_documents_score = 5
        vti_scripts_score = 5
...
rule disable_antivirus {
    meta:
        ...
        classifications = "Host Security Disabling"
	    version = "0.2"
    strings:
...
rule disable_registry {
    meta:
        ...
        classifications = "Host Feature Disabling"
	version = "0.1"
    strings:
...
rule win_hook {
    meta:
        ...
        vti_msi_score = 5
        vti_static_score = 5
        description = "Table Hooking malware detection"
        classifications =  "Hooking"
    version = "0.1"
    strings:
...
{
	meta:
    	author = "@abhinavbom, updated by Femi"
		maltype = "NA"
		version = "0.1"
		date = "31/10/2015"
        vti_default_score = 5
